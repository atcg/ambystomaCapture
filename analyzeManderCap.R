...
plot(mappingStatsNoDSN$CTSonly6iterRawMapRatePERCENT[-18] ~ mappingStatsNoDSN$post.50_uL_PCR_totalDNA[-18], col=mappingStatsNoDSN$individual[-18], pch=20, xlab="Total DNA after amplifying 1/2 of the post-enrichment pool (ng)", ylab="Raw mapping rate (%)", main="Removing Outlier", cex=1.2)
